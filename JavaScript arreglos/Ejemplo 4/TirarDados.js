...
} // fin de la función calcularTrios
...
function actualizarTablaFrecuencias(){
    var resultados = "<table><caption>Frecuencias de tiro de dado</caption><thead><th>Cara</th>"+ 
        "<th>Frecuencias</th><th>Procentajes</th></thead><tbody>";
